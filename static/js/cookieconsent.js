  ...
  cc.Popup = (function() {
    var defaultOptions = {
      ...
      elements: {
        ...
        dismiss:
          '<a aria-label="dismiss cookie message" role=button tabindex="0" id="dismiss" class="cc-btn cc-dismiss">{{dismiss}}</a>',
        allow:
          '<a aria-label="allow cookies" role=button tabindex="0"  class="cc-btn cc-allow">{{allow}}</a>',
        deny:
          '<a aria-label="deny cookies" role=button tabindex="0" id="deny" href="{{href2}}" rel="noopener noreferrer nofollow"  class="cc-btn cc-deny">{{deny}}</a>',
        link:
      ...
      revokeBtn: '<div id=cc_revoke class="cc-revoke {{classes}}">{{policy}}</div>',
    ...
    CookiePopup.prototype.initialise = function(options) {
      ...
      if (this.options.static) {
        ...
        var wrapper = appendMarkup.call(
          this,
          '<div id=cc-gp1 class="cc-grower" >' + cookiePopup + '</div>'
        );
